...
void *myrealloc(void *ptr, size_t size)
{
    ...
    //reallocate size of dynamically allocated memory
    if (ptr)
...
{
    string startTime = getTimeinSeconds("2019-01-10T16:00:00");
    string endTime = getTimeinSeconds("2019-08-20T16:00:00");
